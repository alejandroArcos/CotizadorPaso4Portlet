...
@Component(immediate = true, property = { "javax.portlet.name=" + CotizadorPaso4PortletKeys.PANTALLA, "mvc.command.name=/getDocsEmision" }, service = MVCResourceCommand.class)
